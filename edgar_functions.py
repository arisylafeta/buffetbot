...
headers = {"User-Agent": "ari.sylafeta@gmail.com"} 
...
def standardize_date(date_str: str) -> str:
    """
    Standardizes date strings by converting them to a full month name format.

    Args:
        date_str (str): The date string to be standardized.
    ...
    standardized_date = date_obj.strftime("%d-%B-%Y")
